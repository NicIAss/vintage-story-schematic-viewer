...
```html
<script type="module"
  src="https://cdn.example.org/@vs-schematic/viewer-element/0.4.4/index.js"></script>
...
- Renderer packages use semantic versions, for example `0.4.4`.
